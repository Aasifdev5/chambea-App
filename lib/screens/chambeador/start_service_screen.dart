...
class _StartServiceScreenState extends State<StartServiceScreen> {
  ...
  Future<void> _checkContractOffer() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final contracts = responseData['data'] as List<dynamic>;
        setState(() {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ] else if (widget.job.status == 'En curso') ...[
                      SlideAction(
                        borderRadius: 12,
                        elevation: 0,
